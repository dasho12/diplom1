...
export default function EmployerRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push("/employer/login?message=Registration successful! Please login.");
    } catch (error) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div ref={pageRef} className="w-[1920px] h-[947px] relative bg-white overflow-hidden">
        ...
        <Image 
          ...
          width={720} 
          height={520} 
          className="absolute left-[190px] top-[120px]" 
        />
        {/* Бүртгүүлэх холбоос */}
        <div className="absolute left-[230px] top-[820px] flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col">
                <div className="flex flex-col mb-[5px]">
                  <div className="text-[#0C213A] text-[36px] font-bold font-poppins">Ажил олгогч бүртгүүлэх</div>
                </div>
                ...
                <div className="flex flex-col gap-[25px] w-[564px] mb-[20px]">
                  ...
                  <div className="flex flex-col gap-[5px]">
                    <div className="flex flex-col gap-[4px]">
                      <div className="h-[27px] text-[#0C213A] text-[16px] font-poppins">Компанийн нэр</div>
                    </div>
                    <input 
                      name="companyName" 
                      type="text"
