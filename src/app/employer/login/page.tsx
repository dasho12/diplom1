  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div ref={pageRef} className="w-[1915px] h-[947px] relative bg-white overflow-hidden">
        ...
        <div className="absolute left-[492.5px] top-[833px] text-white text-[20px] font-poppins font-bold">Нэвтрэх</div>
        {/* Зүүн тал: Форм */}
            ...
            <div className="flex flex-col">
              <div className="flex flex-col">
                <div className="flex flex-col mb-[15px]">
                  <div className="text-[#0C213A] text-[36px] font-bold font-poppins">Ажил олгогч нэвтрэх</div>
                </div>
